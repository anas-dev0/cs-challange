...
export default function AuthModal() {
  ...
  <div className="p-6 sm:p-8 max-h-[85vh] overflow-y-auto">
            ...
            {isRegister && (
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-primary-500 focus:ring-0 outline-none transition-all text-gray-900"
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            {isRegister ? (
              <span>Already have an account? <button onClick={() => openAuthModal('login')} className="text-primary-600 font-semibold hover:text-primary-700">Login</button></span>
            ) : (
