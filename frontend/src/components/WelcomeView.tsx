...
function FeatureCard({ icon: Icon, title, description }: FeatureCardProps) {
  return (
    <Card className="border-white/20 bg-white/10 backdrop-blur-md hover:bg-white/15 transition-all hover:scale-105 hover:shadow-2xl">
...
export default function WelcomeView({ onGetStarted }: WelcomeViewProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 flex flex-col items-center justify-center p-8 relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="max-w-6xl w-full relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <Button
            ...
            size="lg"
            className="bg-white text-purple-600 hover:bg-white/90 shadow-2xl text-lg px-8 py-6 h-auto rounded-full transition-all hover:scale-105"
          >
        ...
        <div className="text-center">
          <p className="text-white/70 text-sm">{t('welcome.footer')}</p>
        </div>
      </div>
    </div>
  )
